...
It is part of the **[FoggyKitchen.com training ecosystem](https://foggykitchen.com/)** and is designed to work cleanly with reusable infrastructure modules such as **`terraform-oci-fk-function`**, **`terraform-oci-fk-ons`**, and future event-driven integration components.
